...
INSERT INTO `compte` (`id`, `idUser`, `type_account`, `owner`, `credit`) VALUES
...
INSERT INTO `utilisateur` (`id`, `pseudo`, `password`, `mail`) VALUES
...
--
ALTER TABLE `compte`
  ADD CONSTRAINT `compte_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `utilisateur` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
